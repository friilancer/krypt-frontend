...
const RoomsLink = ({size, animatePage}) => {
	return (
		<ScrollLink 
			to='rooms' 
			spy={true} smooth={true} duration={size > 765 ? 0 : 200} delay={1000} onSetActive={() => animatePage('rooms', 'home')}
			className="md:hidden block px-1 sm:px-4 cursor-pointer font-semibold hover:font-bold"
		>
			Rooms
		</ScrollLink>
	)
...
const GalleryLink = ({size, animatePage}) => {
	return (
		<ScrollLink 
			to='gallery' 
			spy={true} smooth={true} duration={size > 765 ? 0 : 200} delay={1000} onSetActive={() => animatePage('gallery', 'home')}
			className="md:hidden block px-1.5 sm:px-4 cursor-pointer font-semibold hover:font-bold"
		>
		Gallery
		</ScrollLink>
	)
	...
	return(
		<>
			<div name='home' className={`
				...
				<nav>
					<div className="text-gray-800 px-3 sm:px-5 py-2 border-b-2 flex items-center justify-between border-gray-800">
						<span className='px-1.5 sm:px-4 font-bold sm:text-xl'>AXD</span>
						<div className="hidden sm:flex gap-x-1 items-center text-sm">
							...
							<GalleryLink size={size} animatePage={animatePage} />
						{
							...
							:
								<div className="flex gap-x-3 sm:gap-x-8 items-center">
									<Link to='/signin' className="hover:bg-gray-300 py-1 px-2 rounded-md sm:py-2 sm:px-4 font-bold text-sm bg-transparent border border-gray-800 border-2"> Sign In </Link>
									<Link to='/signup' className="hover:bg-gray-300 py-1 px-2 rounded-md sm:py-2 sm:px-4 font-bold text-sm bg-transparent border border-gray-800 border-2"> Sign Up </Link>
								</div>
						}
						</div>
					...
					{
						isOpen &&
						<div className={`py-2 animate-fadeIn px-4 border-b border-black sm:hidden`}>
								...
								<GalleryLink size={size} animatePage={animatePage} />
							{
								...
								:
									<div className="flex flex-col items-start gap-y-3">
										<Link to='/signin' className="py-1 mx-1.5 px-2 rounded-md sm:py-2 sm:px-4 font-bold text-sm bg-transparent border border-gray-800 border-2 hover:bg-gray-100"> Sign In </Link>
										<Link to='/signup' className="py-1 mx-1.5 px-2 rounded-md sm:py-2 sm:px-4 font-bold text-sm bg-transparent border border-gray-800 border-2 hover:bg-gray-100"> Sign Up </Link>
									</div>
							}
							</div>
			...
			<div className='grid md:grid-cols-2-auto w-screen min-w-fit'>
				...
				flex flex-col md:h-screen w-full mx-auto`}>
					<div className='flex flex-col h-screen md:h-auto md:flex-row gap-y-6 items-center md:items-stretch max-w-screen-xl justify-evenly py-3 my-3 mx-auto w-full'>
							...
							<div className='w-2/3 h-2/3 md:h-auto max-w-xs md:w-1/5 bgSuiteImage lg:w-1/6 flex flex-col items-center justify-center cursor-pointer'>
							...
							<img alt='' src={suiteImage} className='w-2/3 max-w-xs md:w-1/6 hidden md:invisible md:block'/>
							<div className='w-2/3 h-2/3 md:h-auto max-w-xs md:w-1/5 bgHallwayImage lg:w-1/6 flex flex-col md:relative md:right-20 items-center justify-center cursor-pointer md:relative md:bottom-2 '>
							...
							<div className='w-2/3 h-2/3 md:h-auto max-w-xs bgRoomImage md:w-1/5 lg:w-1/6 flex flex-col items-center justify-center cursor-pointer md:relative z-10 md:top-16 lg:top-20'>
					...
					<div className='flex flex-col h-screen md:h-auto md:flex-row items-center gap-y-6 md:items-stretch max-w-screen-xl justify-evenly py-3 my-3 lg:py-1 lg:my-1 mx-auto w-full'>
							<div className='w-2/3 h-2/3 md:h-auto max-w-xs md:w-1/5 bgDiningImage flex flex-col items-center justify-center cursor-pointer'>
							...
							<div className='w-2/3 h-2/3 md:h-auto max-w-xs md:w-1/5 bgLandscapeImage flex flex-col items-center justify-center cursor-pointer md:relative z-10 md:top-16 lg:top-20'>
							...
							<div className='w-2/3 h-2/3 md:h-auto max-w-xs md:w-1/5 bgRoomPeekImage flex flex-col items-center justify-center cursor-pointer'>
							...
							<img alt='' src={receptionImage} className='w-0 max-w-xs md:w-1/5 hidden md:invisible md:block' />
					</div>
					<div className='flex h-screen md:h-auto flex-col md:flex-row items-center gap-y-6 md:items-stretch max-w-screen-xl justify-evenly py-3 my-3 lg:py-1 lg:my-1 mx-auto w-full'>
							<img alt='' src={receptionImage} className='w-2/3 max-w-xs md:w-1/5 hidden md:invisible md:block' />
							<div className='w-2/3 h-2/3 md:h-auto max-w-xs md:w-1/5 flex flex-col items-center hidden md:invisible md:block'></div>
							<div className='w-2/3 h-2/3 md:h-auto max-w-xs md:w-1/5 bgMassageRoomImage flex flex-col items-center justify-center cursor-pointer'>
							...
							<div className='w-2/3 h-2/3 md:h-auto max-w-xs md:w-1/5 bgReceptionImage h-full md:relative md:bottom-8 lg:bottom-10 flex flex-col items-center justify-center cursor-pointer'>
