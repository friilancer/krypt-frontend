	...
	return(
		<>
			<div className={`
				...
				h-screen grid w-screen grid-rows-auto-2 items-center py-3 md:py-8`}>
				<nav className="text-gray-800 px-3 sm:px-5 py-2 border-b-2 flex items-center justify-between border-gray-800">
					...
					<div className="flex gap-x-3 items-center">
						<ScrollLink 
							...
							className="md:hidden block px-1.5 px-1.5 sm:px-4 cursor-pointer font-semibold"
						>
							Rooms
						</ScrollLink>
						<ScrollLink 
			...
			<div name="rooms" className={
				...
				md:h-screen w-screen lg:py-2 lg:gap-y-3 flex flex-col py-5 lg:flex-row max-w-screen-xl mx-auto gap-x-5 gap-y-5 lg:gap-x-10 px-3 sm:px-5`}>
			...
			flex flex-col sm:h-screen w-screen`}>
